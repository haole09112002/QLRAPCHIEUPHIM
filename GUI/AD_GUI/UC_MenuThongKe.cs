...
namespace GUI.AD_GUI
{
    public partial class UC_MenuThongKe : UserControl
    {
        ...
        public void setColor()
        {
            ...
            btnMenuNhanVien.BackColor = Color.FromArgb(226, 251, 242);
        }
        public delegate void Mydel (Control control);
        public Mydel d { get; set; }
        public UC_ThongKeNhanVien ucThongKeNhanVien = new UC_ThongKeNhanVien();
        ...
        {
            d(ucThongKeNhanVien);
            changeColorButton(btnMenuNhanVien);
        }
        ...
        private void changeColorButton(Button btn)
        {
            ...
            List<Button> buttons = new List<Button> {btnMenuNhapXuat, btnMenuNhanVien, btnMenuThongTinChung};
