...
select hd.NgayBatDauBanQuyen, hd.NgayKetThucBanQuyen, hd.SoLuong, hd.GiaTien from HOP_DONG_PHIM hd where hd.MaPhim = 'P00001' and hd.MaHopDong = 'HD0001' and hd.PhienBan!='0' order by hd.PhienBan asc